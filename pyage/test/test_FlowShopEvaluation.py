...
class TestFlowShopEvaluation(TestCase):
    ...
    def test_compute_makespan_1(self):
        ...
        makespan, completion_times = evaluation.compute_makespan([0, 1, 2], True)
        ...
        makespan, completion_times = evaluation.compute_makespan([1, 2, 0], True)
    ...
    def test_compute_makespan_2(self):
        ...
        makespan, completion_times = evaluation.compute_makespan(range(6), True)
        ...
        makespan, completion_times = evaluation.compute_makespan([4, 3, 5, 1, 2, 0], True)
